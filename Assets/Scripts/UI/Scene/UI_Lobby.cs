...
public class UI_Lobby : UI_Scene
{
    ...
    void Update()
    {
        if (!CoroutineRunning)
        {
            ...
            else
            {
                ...
                Managers.s_managersProperty.isFirstGameProperty = false;
    ...
    IEnumerator ResultInputNameCoroutine()
    {
        ...
        if (!Managers.uiManagerProperty.IsPopupOpen<UI_DoInput>())
        {
            ...
            yield return new WaitUntil(() => !Managers.uiManagerProperty.IsPopupOpen<UI_DoInput>() && !Managers.uiManagerProperty.IsPopupOpen<UI_Welcome>());
    ...
    void ShowBackgroundImg()
    {
        ...
        {
            Get<GameObject>((int)GameObjects.background2).SetActive(false);
            Get<GameObject>((int)GameObjects.background3).SetActive(true);
        }
    }
